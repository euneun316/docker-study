...
# spark-base
docker build --no-cache --platform linux/amd64 -f spark-base.Dockerfile --build-arg spark_version="3.1.2" --build-arg hadoop_version="3.2" -t imok2/spark-base:spark3.1.2 .
# spark-master
...
# jupyterlab
docker build --no-cache --platform linux/amd64 -f jupyterlab.Dockerfile --build-arg spark_version="3.1.2" --build-arg jupyterlab_version="2.2.6" -t imok2/jupyterlab:spark3.1.2 .
```
